...
namespace LibreUtau.Core.USTx {
    ...
    public class IntExpression : UExpression {
        ...
        public override UExpression Clone(UNote newParent) {
            return new IntExpression(newParent, Name, Abbr) {Min = Min, Max = Max, Data = Data};
        }
    ...
    public class PitchPoint : ExpPoint {
        ...
        public PitchPoint(double x, double y, PitchPointShape shape = PitchPointShape.SINE_IN_OUT) : base(x, y) {
            Shape = shape;
        }
