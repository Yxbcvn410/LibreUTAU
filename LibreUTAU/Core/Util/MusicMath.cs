...
namespace LibreUtau.Core
{
    public static class MusicMath
    {
        ...
        public static double InterpolateShape(Point p0, Point p1, double x, USTx.PitchPointShape shape)
        {
            switch (shape)
            {
                case USTx.PitchPointShape.io: return SinEasingInOut(p0, p1, x);
                case USTx.PitchPointShape.i: return SinEasingIn(p0, p1, x);
                case USTx.PitchPointShape.o: return SinEasingOut(p0, p1, x);
        ...
        public static double InterpolateShapeX(Point p0, Point p1, double y, USTx.PitchPointShape shape)
        {
            switch (shape)
            {
                case USTx.PitchPointShape.io: return SinEasingInOutX(p0, p1, y);
                case USTx.PitchPointShape.i: return SinEasingInX(p0, p1, y);
                case USTx.PitchPointShape.o: return SinEasingOutX(p0, p1, y);
